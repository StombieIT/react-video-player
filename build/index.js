...
function lr() {
  if (Oe) return D;
  Oe = 1;
  var M = Pe, w = Symbol.for("react.element"), U = Symbol.for("react.fragment"), m = Object.prototype.hasOwnProperty, A = M.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner, I = { key: !0, ref: !0, __self: !0, __source: !0 };
  function C(h, c, T) {
  ...
  return D.Fragment = U, D.jsx = C, D.jsxs = C, D;
}
var F = {};
/**
 * @license React
...
function cr() {
  return Se || (Se = 1, process.env.NODE_ENV !== "production" && function() {
    var M = Pe, w = Symbol.for("react.element"), U = Symbol.for("react.portal"), m = Symbol.for("react.fragment"), A = Symbol.for("react.strict_mode"), I = Symbol.for("react.profiler"), C = Symbol.for("react.provider"), h = Symbol.for("react.context"), c = Symbol.for("react.forward_ref"), T = Symbol.for("react.suspense"), p = Symbol.for("react.suspense_list"), b = Symbol.for("react.memo"), E = Symbol.for("react.lazy"), W = Symbol.for("react.offscreen"), Q = Symbol.iterator, we = "@@iterator";
    function Ce(e) {
    ...
    function Ie(e) {
      return !!(typeof e == "string" || typeof e == "function" || e === m || e === I || Ae || e === A || e === T || e === p || Fe || e === W || xe || ke || De || typeof e == "object" && e !== null && (e.$$typeof === E || e.$$typeof === b || e.$$typeof === C || e.$$typeof === h || e.$$typeof === c || // This needs to include all possible module reference object
...
var vr = Z.exports;
const pr = () => /* @__PURE__ */ vr.jsx("video", {});
export {
  pr as VideoPlayer
};
